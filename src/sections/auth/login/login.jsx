...
export default function Login() {
    ...
    const [formData, setFormData] = useState({
        identifier: '', // healthId/licenseNumber
        password: '',
    });
                ...
                <div className="max-w-md w-full mx-auto space-y-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            <button 
                                type="submit" 
                                className="w-full mt-5 bg-gray-900 text-white px-4 py-3 rounded-full font-albulaBold hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 transition-all ease-in-out duration-200"
                            >
