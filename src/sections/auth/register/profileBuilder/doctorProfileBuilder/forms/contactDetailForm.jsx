...
function ContactDetails({setContactSubmit, doctor}) {
    const { licenseNumber } = useParams();

    const [doctorContactDetails, setDoctorContactDetails] = useState({
        contactNumber: '',
        appartmentNumber: '',
        streetNumber: '',
        city: '',
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await contract.methods
                .registerDoctorContactDetails(
                    licenseNumber,
                    doctorContactDetails.contactNumber,
                    doctorContactDetails.appartmentNumber,
                    doctorContactDetails.streetNumber,
                    doctorContactDetails.city,
                    doctorContactDetails.state,
                    doctorContactDetails.country
                )
    ...
    const handleInputChange = (e, field) => {
        ...
        setDoctorContactDetails((prevDetails) => ({
            ...prevDetails,
            [field]: value,
        }));
    };
                ...
                <section>
                    <div className="mt-4">
                        ...
                        <input
                            ...
                            value={doctorContactDetails.contactNumber}
                    ...
                    <div className="mt-4">
                        ...
                        <input
                            type="text"
                            className="mt-1 p-3 border rounded-lg w-full bg-gray-50 focus:ring-2 focus:ring-indigo-500"
                            value={doctorContactDetails.appartmentNumber}
                    ...
                    <div className="mt-4 flex space-x-4">
                        <div className="w-1/2">
                            ...
                            <input
                                type="text"
                                className="mt-1 p-3 border rounded-lg w-full bg-gray-50 focus:ring-2 focus:ring-indigo-500"
                                value={doctorContactDetails.streetNumber}
                        ...
                        <div className="w-1/2">
                            ...
                            <input
                                type="text"
                                className="mt-1 p-3 border rounded-lg w-full bg-gray-50 focus:ring-2 focus:ring-indigo-500"
                                value={doctorContactDetails.city}
                    ...
                    <div className="mt-4 flex space-x-4">
                        <div className="w-1/2">
                            ...
                            <input
                                type="text"
                                className="mt-1 p-3 border rounded-lg w-full bg-gray-50 focus:ring-2 focus:ring-indigo-500"
                                value={doctorContactDetails.state}
                        ...
                        <div className="w-1/2">
                            ...
                            <input
                                type="text"
                                className="mt-1 p-3 border rounded-lg w-full bg-gray-50 focus:ring-2 focus:ring-indigo-500"
                                value={doctorContactDetails.country}
